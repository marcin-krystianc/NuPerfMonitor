...
ForEach ($version In $versions) {
	...
	. "$PSScriptRoot\..\NuGet.Client\scripts\perftests\RunPerformanceTests.ps1" -nugetClientFilePath "$version\dotnet" -solutionFilePath $solutionFilePath -resultsFilePath $resultsFilePath -iterationCount 1
}